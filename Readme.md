...
* **Added hyperlink icon**  to distinguish local protocal for different softwares from web links,to learn all supported link, see [more info](https://www.yuque.com/achuan-2/siyuan/gar358)  
