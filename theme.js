...
function sidebarHoverButtonImplementEven() {
    loadStyle('/appearance/themes/Tsundoku Dark/style/topbar.css', 'topbarCss');
...
function createHighlightBecomesHidden() {
    loadStyle('/appearance/themes/Tsundoku Dark/style/mark-display.css', 'markCss');
...
function highlightBecomesHiddenButtonClickEven() {
    ...
    if (obj.getAttribute('href') != '/appearance/themes/Tsundoku Dark/style/mark-display.css') {
        obj.setAttribute('href', '/appearance/themes/Tsundoku Dark/style/mark-display.css');
        ...
        obj.setAttribute('href', '/appearance/themes/Tsundoku Dark/style/mark-hide.css');
 ...
 */
window.theme.changeThemeMode = function (lightStyle, darkStyle, customLightStyle, customDarkStyle) {
    let href_color = null;
...
window.theme.loadScript('/appearance/themes/Tsundoku Dark/script/module/window.js');
window.theme.loadScript('/appearance/themes/Tsundoku Dark/script/module/doc.js');
window.theme.loadScript(
    window.theme.addURLParam('/appearance/themes/Tsundoku Dark/script/module/goto.js'),
    undefined,
    true
);
window.theme.loadScript(
    window.theme.addURLParam('/appearance/themes/Tsundoku Dark/script/module/menu.js'),
    undefined,
    true
);
